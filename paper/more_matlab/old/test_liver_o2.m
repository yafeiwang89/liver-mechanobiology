...
function [X,Y,central_vein_positions,oxygen,nearest_index,distance_to_nearest_central_vein,s] = test_liver_o2( parameters )
...
% radius_temp = parameters.lobule_radius * ( parameters.min_central_vein_spacing / (2* parameters.lobule_radius ) ); 

typical_lobular_area = pi*radius_temp^2; %  parameters.lobule_radius^2; % cylindrical approximation

number_of_lobules = ceil( domain_area / typical_lobular_area );

% number_of_lobules = ceil( number_of_lobules * 1.4 ); 
